...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Prepare and bind
    $stmt = $conn->prepare("INSERT INTO payment_details (fullname, email, address, city, state, zip, cardname, cardnumber, expmonth, expyear, cvv) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("sssssssssss", $fullname, $email, $address, $city, $state, $zip, $cardname, $cardnumber, $expmonth, $expyear, $cvv);
...
<body>
    ...
    <br>
        ...
        <div class="col-75">
        <div class="container">
            <form id="validate" method="POST" action="Checkout.php">
                <div class="row">
                    <div class="col-50">

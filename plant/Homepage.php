...
<head>
	...
	<body>
		<header>
			<div class="navbar">
				<div class="title">
					<a href="Homepage.php">Plants Nursery</a>
				</div>
				<nav>
					<ul>
						...
						<li><a href="./product/add2cart.php"><i class="fa fa-shopping-cart fa-lg"></i></a></li>
		...
		<div class="imgslider">
			<div class="banner1">
				<img src="I2.jpg" height="500">
			</div>
			<div class="banner2">
				<img src="I6.jpg" height="500">
			</div>
			<div class="banner3">
				<img src="I5.jpg" height="500">
			</div>
			<div class="banner4">
				<img src="I1.jpg" height="500">
			</div>
		</div>
		<br><br><br><br>
		...
		<div class="Categories">
         	<div class="card">
	            <div class="img">
	               <a href="Indoor.html"><img src="Indoor.jpg"></a>
	            </div>
	            <div class="content">
	        ...
	        <div class="card">
	            <div class="img">
	               <a href="Medicinal.html"><img src="Medicinal.jpg"></a>
	            </div>
	            <div class="content">
	        ...
	        <div class="card">
	            <div class="img">
	               <a href="Fruits.html"><img src="fruits.jpg"></a>
	            </div>
	            <div class="content">
	        ...
	        <div class="card">
	            <div class="img">
	               <a href="Flowers.html"><img src="flowers.jpg"></a>
	            </div>
	            <div class="content">
	        ...
	        <div class="card">
	            <div class="img">
	               <a href="Bonsai.html"><img src="bonsai.jpg"></a>
	            </div>
	            <div class="content">
	        ...
	        <div class="card">
	            <div class="img">
	               <a href="Cactus.html"><img src="cactus.jpg"></a>
	            </div>
	            <div class="content">
	        ...
	        <div class="card">
	            <div class="img">
	               <a href="Religious.html"><img src="Religious.jfif"></a>
	            </div>
	            <div class="content">
      	...
      	<div class="Blogs">
	      	<div class="blog">
	      		<div class="blog-img">
	      			<a href="blog1.html"><img src="blog1.jfif"></a>
	      		</div>
	      		<div class="blog-content">
	      			<h6>10 jan 2021 | CKRV</h6>
	      	...
	      	<div class="blog">
	      		<div class="blog-img">
	      			<a href="blog2.html"><img src="blog2.jpg"></a>
	      		</div>
	      		<div class="blog-content">
	      			<h6>20 Jan 2021 | CKRV</h6>
	    ...
	    <div class="v-container">
			<video autoplay loop muted width="1000">
				<source src="video.mp4" type="video/mp4" width="500">
			</video>
			<div class="text-box">
	    ...
	    <br>
		<footer>
			<div class="BackToTop"><center><a href="Homepage.html"> BACK TO TOP </a></center></div>
			<div class="main-content">
				<div class="left box">
					<h2>About us</h2>
					<div class="content">
						<p>My Name is CKRV</p>
						<p>Currently studying in TYIT from SSASIT College.</p>
						<p>This is our DE Project - A Plants Nursery Website.</p>
				...
				<div class="center box">
					...
					<div class="content">
						...
						<div class="email">
							...
							<span class="text"> CKRV5103061@gmail.com </span>
						</div>
						<div class="downtitle">
							Plants Nursery
						</div>
			...
			<div class="bottom">
				<center>
					<span class="credit">Created By CKRV GROUP</span>
